...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            Log.d("fetch","ioException");

            // Catch network or other I/O problems.
            errorMessage = getString(R.string.service_not_available);
            Log.e(TAG, errorMessage, ioException);
        } catch (IllegalArgumentException illegalArgumentException) {
            Log.d("fetch","IllegalArgumentException");
...
//                remoteViews.setViewVisibility(R.id.refresh_widget, View.INVISIBLE);
//                remoteViews.setViewVisibility(R.id.widget_progressBar, View.INVISIBLE);

                appWidgetManager.updateAppWidget(componentName, remoteViews);
            }catch (Exception e){

                Log.d("fetch_widget","crash_updating");
                e.printStackTrace();
            }
